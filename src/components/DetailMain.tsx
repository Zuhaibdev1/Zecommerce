...
const DetailMain = () => {
    ...
    useEffect(() => {
        fetch(`http://localhost:4000/products/${id}`)
            .then(res => res.json())
            .then(res => setDetailProducts(res))
    }, [])
            ...
            <div className="container-fluid py-5">
                <div className="row px-xl-5">
                        ...
                        <div id="product-carousel" className="carousel slide" data-ride="carousel">
                            <div className="carousel-inner border">
                                <div className="carousel-item active">
                                    <img className="w-100 h-100" src={detailProducts.image} alt="Image" />
                                </div>
                            </div>
                    ...
                    <div className="col-lg-7 pb-5">
                        <h3 className="font-weight-semi-bold">{detailProducts.title}</h3>
                        ...
                        <div className="d-flex mb-3">
                            ...
                            <form>
                                <div className="custom-control custom-radio custom-control-inline">
                                    ...
                                    <label className="custom-control-label" for="size-1">{detailProducts.sizes}</label>
                                </div>
                                <div className="custom-control custom-radio custom-control-inline">
